...
local preLoadApi = {
  { paste = "AndreyA4/OpenComputers/master/lib/ECSAPI.lua", path = "lib/ECSAPI.lua" },
  { paste = "AndreyA4/OpenComputers/master/lib/colorlib.lua", path = "lib/colorlib.lua" },
  { paste = "AndreyA4/OpenComputers/master/lib/image.lua", path = "lib/image.lua" },
  { paste = "AndreyA4/OpenComputers/master/lib/config.lua", path = "lib/config.lua" },
  { paste = "AndreyA4/OpenComputers/master/MineOS/Icons/Languages.pic", path = "ServerOS/System/OS/Icons/Languages.pic" },
  { paste = "AndreyA4/OpenComputers/master/MineOS/Icons/OK.pic", path = "ServerOS/System/OS/Icons/OK.pic" },
  { paste = "AndreyA4/OpenComputers/master/MineOS/Icons/Downloading.pic", path = "ServerOS/System/OS/Icons/Downloading.pic" },
  { paste = "AndreyA4/OpenComputers/master/MineOS/Icons/OS_Logo.pic", path = "ServerOS/System/OS/Icons/OS_Logo.pic" },
}
...
local imageOS = image.load("ServerOS/System/OS/Icons/OS_Logo.pic")
local imageLanguages = image.load("ServerOS/System/OS/Icons/Languages.pic")
local imageDownloading = image.load("ServerOS/System/OS/Icons/Downloading.pic")
local imageOK = image.load("ServerOS/System/OS/Icons/OK.pic")
...
do
  ...
  local pathToLang = "ServerOS/System/OS/Installer/Language.lang"
  getFromGitHubSafely(GitHubUserUrl .. "AndreyA4/OpenComputers/master/Installer/" .. _G.OSSettings.language .. ".lang", pathToLang)
  getFromGitHubSafely(GitHubUserUrl .. "AndreyA4/OpenComputers/master/MineOS/License/" .. _G.OSSettings.language .. ".txt", "MineOS/System/OS/License.txt")
